...
uxv1 = UxV(name="alpha", position=(5,15), speed=(30), sensorRange=(10), type="UUV", endurance=200)
uxv2 = UxV(name="bravo", position=(35,275), speed=(10), sensorRange=(15), type="UUV", endurance=100)
uxv3 = UxV(name="charlie", position=(105,275), speed=(15), sensorRange=(15), type="UUV", endurance=100)
uxv4 = UxV(name="delta", position=(100, 210), speed=(20), sensorRange=(15), type="UUV", endurance=100)

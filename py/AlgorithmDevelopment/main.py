...
uxvs = []
uxvs.append(UxV(name="alpha", position=(5,15), speed=(10), sensorRange=(2), type="UUV", endurance=200))
uxvs.append(UxV(name="bravo", position=(45,211), speed=(5), sensorRange=(2), type="UUV", endurance=100))
uxvs.append(UxV(name="charlie", position=(155,275), speed=(10), sensorRange=(2), type="UUV", endurance=100))
uxvs.append(UxV(name="delta", position=(315, 45), speed=(20), sensorRange=(20), type="UUV", endurance=100))

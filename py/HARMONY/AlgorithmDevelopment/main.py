...
uxvs = []
uxvs.append(UxV(name="alpha", position=(5,15), speed=(5), sensorRange=(10), type="UUV", endurance=200))
uxvs.append(UxV(name="bravo", position=(20,5), speed=(5), sensorRange=(10), type="UUV", endurance=100))
uxvs.append(UxV(name="charlie", position=(600,75), speed=(10), sensorRange=(5), type="UUV", endurance=100))
uxvs.append(UxV(name="delta", position=(600, 76), speed=(20), sensorRange=(20), type="UUV", endurance=100))

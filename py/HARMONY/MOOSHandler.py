...
class MOOSHandler:
    ...
    def __init__(self, host, port, client_name, time_warp):
        ...
        self.grid_data          = None
        self.active_uavs        = {}       # Used in main, compared to completed_uavs
        self.active_uuvs        = {}       # Used in main, compared to completed_vehicles
        ...
        for msg in messages:
            match msg.key():
                ...
                case "SURVEY_AREA":
                    ...
                    if len(self.available_vehicles) > 0 or len(self.available_uavs) > 0:
